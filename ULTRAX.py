...
BOT = str(botnickname) if botnickname else "CAPTAIN"
NAME = str(ALIVE_NAME) if ALIVE_NAME else "CAPTAIN"
PHOTO = os.environ.get("ALIVE_PHOTTO", None)
ULTRAX = "[CAPTAIN](https://t.me/publictechno)"
VERSION = "0.0.1"
...
MASTER = NAME
GROUP = "[SUPPORT GROUP](https://t.me/publictechno)"
